...
// Package golang implements a verifiable random function using curve p256.
package main
...
func GenerateKey() (VRFPrivateKey, VRFPublicKey) {
...
//func NewFromWrappedKey(ctx context.Context, wrapped proto.Message) (VRFPrivateKey, error) {
...
func NewVRFSigner(key *ecdsa.PrivateKey) (VRFPrivateKey, error) {
...
func NewVRFVerifier(pubkey *ecdsa.PublicKey) (VRFPublicKey, error) {
...
func NewVRFSignerFromPEM(b []byte) (VRFPrivateKey, error) {
	p, _ := pem.Decode(b)
	if p == nil {
...
func NewVRFSignerFromRawKey(b []byte) (VRFPrivateKey, error) {
...
func NewVRFVerifierFromPEM(b []byte) (VRFPublicKey, error) {
	p, _ := pem.Decode(b)
	if p == nil {
		return nil, ErrNoPEMFound
	}
...
func NewVRFVerifierFromRawKey(b []byte) (VRFPublicKey, error) {
